                ...
                <section class="section-inside">
                  <div class="section-inside-header">
                    ...
                    <ul class="inside-nav">
                      ...
                      <li><a href="GeneralWorkshops_SchedulesLocations-SouthEast.php">&larr; Southeastern Region</a></li>
                      <!-- <span class="vert">&vert;</span> -->
                    </ul>
                    <hr class="work-hr">
                  </div>
                  ...
                  <div class="banner">
                    ...
                    <div id="my-content" class="section-inside-content">
                        ...
                        <p class="reg-flyer">Please have a copy of our <a class="page-link" href="southcentral-3p-1219.pdf"
                                                                          target="_blank" rel="noopener">Southcentral regional flyer </a></p>
                        <h5>Dallas-Fort Worth, Texas: 3-Part Series on October  17-24, 2020 - online</h5>
                        <table class="table-credits table-praises" >
                            ...
                            <tr>
                                <td >Depth Contact</td>
                                <td >10/20: (9 am-12:30 pm; 2-5 pm) <br>10/21: (9 am-12 pm;
                                    1:30-4:30 pm)</td>
                                <td >$ 215</td>
                            </tr>
                            <tr>
                                <td >Life Integration</td>
                                <td >10/23: (9 am-12:30 pm; 2-5 pm) <br>10/24: (9 am-12 pm;
                                    1:30-4:30 pm)</td>
                                <td >$ 215</td>
                            </tr>
                            <tr>
                        ...
                        <!-- <br><br> -->
                        <p>*  Tuition only.   Workshop not held on October 19 and 22.   Life Context workshop includes
